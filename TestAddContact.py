...
class TestAddContact(unittest.TestCase):
    ...
    def test_add_conctact(self):
        wd = self.wd
        self.open_URL(wd)
        self.Login(wd, username="admin", password="secret")
        self.open_contact_page(wd)

        self.create_abon_add_abon_info(wd, Contact(
    ...
    def create_abon_add_abon_info(self, wd, contact):
        ...
        wd.find_element_by_name("middlename").send_keys(contact.abon_middle_name)
        wd.find_element_by_name("lastname").click()
        wd.find_element_by_name("lastname").clear()
        wd.find_element_by_name("lastname").send_keys(contact.abon_last_name)
        wd.find_element_by_name("nickname").click()
        wd.find_element_by_name("nickname").clear()
        wd.find_element_by_name("nickname").send_keys(contact.abon_nikname)
